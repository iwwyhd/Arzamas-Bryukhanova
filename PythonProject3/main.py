...
class Figura(pygame.sprite.Sprite):
    def __init__(self, initial_position, size):
        ...
        self.image = pygame.image.load('etc/figura_' + str(self.go_state) + '.png').convert_alpha()
        ...
        if self.anim_cooldown < 0:
            ...
            if self.anim_air:
                if player_goodie_anim > 0:
                    self.image = figura_jump_goodie
                else:
                    self.image = figura_jump
            else:
                if player_goodie_anim > 0:
                    if self.go_state == 1:
                        self.image = figura_1_goodie
                    if self.go_state == 2:
                        self.image = figura_2_goodie
                    if self.go_state == 3:
                        self.image = figura_3_goodie
                    if self.go_state == 4:
                        self.image = figura_4_goodie
                else:
                    if self.go_state == 1:
                        self.image = figura_1
                    if self.go_state == 2:
...
class Goodie(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if pygame.sprite.collide_rect(self, figura):
...
class Obstacle(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        self.rect.left -= self.speed
        if (player_invincible_time < 0) & pygame.sprite.collide_rect(self, figura):
...
figura_jump = pygame.image.load('etc/figura_jump.png').convert_alpha()
figura_jump_goodie = pygame.image.load('etc/figura_jump_goodie.png').convert_alpha()
figura_1 = pygame.image.load('etc/figura_1.png').convert_alpha()
figura_1_goodie = pygame.image.load('etc/figura_1_goodie.png').convert_alpha()
figura_2 = pygame.image.load('etc/figura_2.png').convert_alpha()
figura_2_goodie = pygame.image.load('etc/figura_2_goodie.png').convert_alpha()
figura_3 = pygame.image.load('etc/figura_3.png').convert_alpha()
figura_3_goodie = pygame.image.load('etc/figura_3_goodie.png').convert_alpha()
figura_4 = pygame.image.load('etc/figura_4.png').convert_alpha()
figura_4_goodie = pygame.image.load('etc/figura_4_goodie.png').convert_alpha()
...
figura = Figura(
    ((screen_width / 2) - (figura_size[0] / 2), screen_height - figura_size[1] - ground_height),
    figura_size)
...
while True:
    ...
    if game_over_anim > 0:
        ...
        screen.blit(figura.image, figura.rect)
